...
- **vertical-coordinate dynamics:** continuity-consistent pressure velocity `omega`, any derived geometric vertical velocity, boundary conditions, and extensions to hybrid/sigma/mass coordinates beyond the canonical pressure-coordinate hydrostatic identities;
