...
| --- | --- | --- | --- | --- |
| `data.immutable_observational_projection` — Create one immutable observational or reanalysis projection | `ready` | `P0` | `R5_large_data` | `data.external_authority_audit`, `state.typed_physical_state` |
