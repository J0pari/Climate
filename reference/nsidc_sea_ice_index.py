"""Provider-specific URL identity and parser for NOAA@NSIDC Sea Ice Index.

The provider publishes one extent/area CSV per hemisphere and month. Climate
retains the versioned URL, schema validation, units, source transitions, and
content identity. HTTP transport is deliberately external to this reference
module; live workflows capture the exact URL with curl and pass bytes here.
"""
