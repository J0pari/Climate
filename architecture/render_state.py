...
def render_state(root: Path = ROOT) -> str:
    ...
    lines = [
        ...
        "",
        "This is the repository-local orientation view composed from the typed authority surfaces declared in `architecture/state_authorities.json`. Exact-head build, test, and workflow outcomes live in GitHub Actions for the commit being inspected.",
        "",
