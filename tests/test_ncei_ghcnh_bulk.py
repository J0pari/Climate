...
class GHCNhFederationTests(unittest.TestCase):
    def test_versioned_annual_archive_identity_is_validated_without_fetching(self):
        url = ARCHIVE_BASE_URL + "ghcn-hourly_v1.0.0_d2026_c20260918.tar.gz"
        self.assertEqual(
            validate_year_archive_url(url),
