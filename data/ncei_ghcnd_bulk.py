"""Bulk NCEI GHCN-Daily parser/router for station federation.

This is the scale path for provider-specific semantics after immutable provider
artifacts have been captured by an external data-transfer system. Climate owns
catalog/inventory parsing, station-federation mapping, provider URL identity,
and streaming observation routing; it does not own generic HTTP transfer,
resume/checkpoint, or remote-validator machinery.
"""
